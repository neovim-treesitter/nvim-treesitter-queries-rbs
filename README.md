# nvim-treesitter-queries-rbs

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-rbs/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-rbs/actions/workflows/validate.yml)

Neovim tree-sitter queries for **rbs**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-rbs",
...
- [ ] Changes are scoped to `rbs` — do not include files for other languages
